...
const ToyCard = ({ toy }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4">
      <img src={pictureUrl} alt={productName} className="w-full h-48 object-cover mb-4 rounded-lg" />
      ...
      <button className="bg-[#ffc837] text-white mt-4 px-4 py-2 rounded-md hover:bg-[#ffb700]">
        View Details
      </button>
    </div>
  );
